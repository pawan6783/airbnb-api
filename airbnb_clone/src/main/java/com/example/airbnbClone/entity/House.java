...
public class House {
	...
	public House(int id, int houseNumber, String img, String name, String description, String area, String city, String state,
			String country, int zipcode, int bedrooms, int bathrooms, int price, int guests, int hostId,
			String hostFirstName, String hostLastName, String hostEmail, String hostLocation) {
		super();
		this.id = id;
	...
	public String toString() {
		return "House [id=" + id + ", houseNumber=" + houseNumber + ", img=" + img + ", name=" + name + ", description="
				...
				+ ", guests=" + guests + ", hostId=" + hostId + ", hostFirstName=" + hostFirstName + ", hostLastName="
				+ hostLastName + ", hostEmail=" + hostEmail + ", hostLocation=" + hostLocation + "]";
	}
